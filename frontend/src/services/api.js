...
/**
 * POST — Send email (mock implementation using localStorage).
 * When a real backend is available, replace this with actual fetch call.
 *
...
export async function sendEmail(claimId, emailData) {
    ...
    // Mock email send - increment follow-ups
    ...
    return {
        success: true,
        message: `Email sent to ${claims[idx].insuranceCompany}`,
